                ...
                <div className="PopularProducts ">
                    <div className="TitleSection h-20 ">
                        <div className="inline-flex items-center justify-center w-full">
                            ...
                            <span className={"px-3 text-3xl xl:text-4xl tracking-widest font-medium text-gray-900 dark:text-black " + montaga.className}>Popular Products</span>
                            <hr className="w-32 xl:w-64 h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
                        </div>
                    </div>
                </div>
                <div className="ProductsList  grid mt-4 gap-12 xl:gap-32 px-6 grid-cols-3 ">
