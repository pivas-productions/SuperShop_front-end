            ...
            <div className="Main2 w-full bg-rose-200">
                <div className="MayBeInteresting ">
                    <div className="TitleSection h-20 ">
                        ...
                        <hr className="w-20 xl:w-64 h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
                            <span className={"px-3 text-3xl xl:text-4xl tracking-widest font-medium text-gray-900 dark:text-black " + montaga.className}>You may be interested</span>
                            <hr className="w-20 xl:w-64 h-px my-8 bg-gray-200 border-0 dark:bg-gray-700" />
                        </div>
                    </div>
                </div>
                <div className="MayBeInteresting  mt-4">
                    ...
                    {Array.from({length:(Math.ceil(Object.values(items).length / 6))}, (_ , i) => i+1).map((i) => {
                        ...
                        return (
                        <div className="codename grid grid-cols-3 grid-rows-2 gap-12 xl:gap-32" key={i}>
